...
| `docs/user/` | a user in depth | every setting, every key, every failure mode (FR-079–FR-081) |
| `docs/dev/` | a contributor in depth | architecture, workflow, contracts, tiers, releasing (FR-082) |
